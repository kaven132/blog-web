...
export default function PostCard({ title, slug, excerpt, tags, createdAt, index = 0 }: PostCardProps) {
  ...
  return (
    <article
      className="group relative bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] p-6 sm:p-7 hover:border-[var(--color-border-hover)] hover:shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] transition-all duration-400 ease-out"
